        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          ...
          <div className="mt-3 sm:mt-0 sm:ml-3">
            <a
              ...
              className="no-global-style w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium text-secondary bg-background hover:text-primary md:py-4 md:text-lg md:px-10"
            >
